...
public interface IComposite<T> extends IElement<T>
{
    ...
    */
     ...
     */
    public static void getAllRecursive( IComposite root, Collection<IElement> out)
    {   
     ...
     */
    public static <A> void getAllRecursive( IComposite<A> root, Collection<IElement> out, boolean checkStackOverflow ) throws StackOverflowError
    {
